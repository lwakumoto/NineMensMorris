...
class RecursiveTicTacToe(override val opponent: String, override var yourTurn: Boolean = true) : Game() {
    ...
    override val gameBoard: RecursiveTicTacToeBoard = RecursiveTicTacToeBoard()
